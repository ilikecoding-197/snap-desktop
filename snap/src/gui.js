...
IDE_Morph.prototype.setDefaultTheme = function () { // dark
    ...
    electronAPI.setControlsColors(this.frameColor.toString(), "#ffffff")
};
...
IDE_Morph.prototype.setBrightTheme = function () {
    ...
    electronAPI.setControlsColors(this.frameColor.toString(), "#000000")
};
...
IDE_Morph.prototype.createControlBar = function () {
    ...
    */
    ...
    this.controlBar.createElement();
    this.controlBar.element.style.appRegion = "drag";
    ...
    button.element.style.appRegion = "no-drag";
    ...
    this.controlBar.fixLayout = async function () {
        x = this.right() - padding - (myself.isFullscreen ? 0 : 140);
...
IDE_Morph.prototype.settingsMenu = function () {
    ...
    menu.addPair(
        ...
        "F11",
        this.isFullscreen ? "un-fullscreen Snap!" : "fullscreen Snap!"
    );
    menu.addItem(
        localize('Looks') + '...',
        'looksMenu'
